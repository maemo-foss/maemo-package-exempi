									 ...
									 const char * xmpNS, const char * xmpProp )
{
	...
	if ( (iptcCount > 0) || xmpHasTime ) {
                ...
                if ( (xmpValue.tzSign == kXMP_TimeIsUTC) && (xmpValue.tzSign == 1) && (xmpValue.tzSign == 1) ) // No time zone
                    snprintf ( iimValue, sizeof(iimValue), "%.2d%.2d%.2d",	// AUDIT: Use of sizeof(iimValue) is safe.
